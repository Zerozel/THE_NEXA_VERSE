...
// 2. Wrap the form in a Suspense boundary so the build doesn't crash
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <Suspense fallback={<div className="text-gray-500 text-center py-4 text-sm">Loading secure login...</div>}>
          <LoginForm />
        </Suspense>
