...
// ─────────────────────────────────────────────────────────────────────────────
// Post-submission confirmation. Reached via:
//   /spotlight/success?token=sp_trk_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
//
// PHASE 3D SCOPE:
//   Displays the tracking token and explains next steps.
//   Does NOT query the database — the tracking token itself is the
//   confirmation (it could only have been issued by a successful
//   POST /api/spotlight/submissions/submit).
//
//   /spotlight/track/[token] (a live status page reading from
//   spotlight_tracking_events) is Phase 3E.
// ─────────────────────────────────────────────────────────────────────────────
